    ...
    protected function render()
    {
        ...
        <div x-cloak x-data = "themeChanger()" @click = "toggleThemes();isDarkness = !isDarkness" class = "toggleTheme cursor-pointer">
            <div :class = "isDark ? 'toggleThemeDark ': 'toggleThemeLight' "
                ...
                <div :class = "!isDark ? 'hidden ': 'size-5' "><?= razmnixIcon('fontawesome/' . $settings[ 'iconDarkType' ] , $settings[ 'iconDarkName' ]); ?></div>
                <div :class = "isDark ? 'hidden ': 'size-5' "><?= razmnixIcon('fontawesome/' . $settings[ 'iconLightType' ] , $settings[ 'iconLightName' ]); ?></div>
            </div>
        </div>
