        ...
        ?>>
            <?php if ($settings[self::NAME . 'Link'] === 'yes'): ?><a href = "<?= $settings[self::NAME . 'Href']; ?>"><?php endif; ?>
                <div :class = "isDarkness ? 'toggleThemeDark' : 'toggleThemeLight'"
                    ...
                    <div :class = "!isDarkness ? 'hidden' : ''"><?= razmnixIcon('fontawesome/' . $settings[self::DARK . 'Type'], $settings[self::DARK . 'Name']); ?></div>
                    <div :class = "isDarkness ? 'hidden' : ''"><?= razmnixIcon('fontawesome/' . $settings[self::LIGHT . 'Type'], $settings[self::LIGHT . 'Name']); ?></div>
