<div class = "flex mb-5">
    <div class = "flex items-center ">
        <a href = "#"
           class = "group lg:w-12 lg:h-12  w-10 h-10 flex items-center relative justify-center rounded-full bg-[#eceeef] dark:bg-[#1b314c] hover:bg-[#334155] transition cursor-pointer">
            <svg width = "22" height = "22" viewBox = "0 0 22 22" fill = "none"
                 xmlns = "http://www.w3.org/2000/svg">
                <path class = "fill-current text-[#334155] dark:text-gray-200 group-hover:text-[#eceeef]"
        ...
        <a class = "mr-2 dark:text-gray-200 text-[#334155]" href = "/cart">سبد خرید</a>
    </div>
</div>