<div x-cloak = "" :class = "userDropDown ? 'z-50' : ' '" @click.away = "overlayShow= false; userDropDown = false" x-show = "userDropDown"
     class = "absolute sm:w-80 w-[17.25rem] dark:bg-dark dark:shadow-lg bg-white rounded-lg overflow-hidden top-16 rtl:-left-4 ltr:-right-4 z-10">
    <div>
        ...
        <div class = "pt-7 px-5">
            <div class = "relative">
                <!-- divider -->
                <span class = "absolute bg-biscay-100 dark:bg-white dark:bg-opacity-10 w-px md:h-full right-[22px] z-[-1]"></span>
                <!-- /divider -->
                ...
                <div class = "pr-12">
                    ...
                    <div class = "relative flex items-center justify-between mb-3">
                        <span class = "w-4 h-4 absolute rounded-full bg-blue-700 rtl:-right-[34px] ltr:-left-[34px]"></span>
                        <div>
                    ...
                    <div class = "relative flex items-center justify-between">
                        <span class = "w-4 h-4 absolute rounded-full bg-yellow-500 rtl:-right-[34px] ltr:-left-[34px]"></span>
                        <div>
                            <span class = "dark:text-gray-100 text-gray-300 font-bold text-sm">باقیمانده اشتراک</span>
                        </div>
                        <div>
                            <span class = "text-yellow-500 font-bold text-sm">352 روز دیگر</span>
                        </div>
                    </div>
                    <!-- user /vip -->
                </div>
        ...
        <!-- divider -->
        <hr class = "dark:border-[#ebecee] dark:border-opacity-10 border-biscay-100 mt-5 mb-3">
        <!-- /divider -->
