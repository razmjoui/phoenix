...
class RazmnixThemesMode extends RazmnixBaseWidget
{
    ...
    const CATEGORIES = ['razmnixWidgets'];
    ...
    protected function render()
    {
        ...
        <div x-cloak x-data = "themeChanger()" @click = "toggleThemes();isDarkness = !isDarkness" xmlns:x-bind = "http://www.w3.org/1999/xhtml">
            <div x-bind:class = "isDarkness ? 'toggleThemeDark ': 'toggleThemeLight' "
                ...
                <div x-bind:class = "isDarkness ? 'hidden ': '' "><?= get_svg_code($settings[ 'iconDarkType' ] , $settings[ 'iconDarkName' ]); ?></div>
                <div x-bind:class = "!isDarkness ? 'hidden ': '' "><?= get_svg_code($settings[ 'iconLightType' ] , $settings[ 'iconLightName' ]); ?></div>
            </div>
        </div>
